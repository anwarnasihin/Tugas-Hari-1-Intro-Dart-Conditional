void main(){
  ...
  switch (quotes) {
    ...
    case "Kamis" :
    print("Jika hatimu banyak merasakan sakit, maka belajarlah dari rasa sakit itu untuk tidakmemberikan rasa sakit pada orang lain.");
    break;
    ...
    break;
  default:
  print("Perhatikan huruf besar huruf kecil dalam penulisan hari");
  }
}